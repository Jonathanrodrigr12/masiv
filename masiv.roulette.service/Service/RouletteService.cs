...
namespace Masiv.Roulette.API.Service
{
    ...
    public class RouletteService : IRouletteService
    {
        ...
        public RouletteAddResponseDto AddRouletteService()
        {
        ...
        public RouletteCloseResponseDto CloseRouletteService(RouletteCloseDto rouletteCloseDto)
        {
        ...
        public RouletteStartResponseDto StartRouletteService(RouletteStartDto rouletteStartDto)
        {
        ...
        public List<RouletteDto> GetAllRoulettesWithStatusService()
        {
